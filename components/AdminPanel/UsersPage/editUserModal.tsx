...
export default function EditUserModal({
   ...
   return (
      <>
         <button
            className='mx-2 rounded-lg bg-green-500 px-5 py-1 duration-500 hover:bg-slate-500'
            onClick={() => setOpen(true)}
         >
            <Paragraph3 className='text-white'>Edit</Paragraph3>
         </button>
                        ...
                        <Dialog.Panel className='relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg'>
                           <div className='bg-white px-4 pb-4 pt-5 sm:p-6 sm:pb-4'>
                              <div className='mb-5 flex items-center text-center'>
                                 ...
                                 >
                                    <Heading4 className=''>Edit Admin</Heading4>
                                 </Dialog.Title>
                              </div>
                              <EditUserForm
                                 setOpen={setOpen}
